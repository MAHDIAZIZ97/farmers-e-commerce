          ...
          <div class="flex flex-col md:flex-row gap-4">
                ...
                <table class="w-full">
                  ...
                  <tbody>
                    ...
                    <tr wire:key="{{$item['product_id']}}">
                      ...
                      @empty
                      <tr>
                        <td class="text-center text-gray-700 text-semibold text-4xl py-4">
            ...
            <div class="md:w-1/4">
              <div class="bg-white rounded-lg shadow-md p-6">
                ...
                @if($cart_items)
                <a href="{{url('/checkout')}}" wire:navigate.hover class="bg-blue-500 block text-center text-white py-2 px-4 rounded-lg mt-4 w-full">Checkout</a>
                @endif
            </div>
            </div>
          </div>
