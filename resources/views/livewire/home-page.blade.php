<div>
    {{-- hero section starts --}}
<div class="w-full h-screen bg-gradient-to-r from-green-500 to-gray-400 py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
      <!-- Grid -->
      <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">Start your journey with <span class="text-blue-600">Local FARM</span></h1>
        ...
        <div class="relative ms-4">
          <img class="w-full rounded-md" src={{asset('img/tea.png')}} alt="Image Description">
  ...
  <section class="py-20">
    <div class="max-w-xl mx-auto">
      <div class="text-center ">
        ...
        <p class="mb-12 text-base text-center text-gray-500">
            Season-wise farming products for e-commerce ensure fresh, sustainable crops like winter vegetables, summer fruits, and monsoon grains, boosting availability.
        </p>
      </div>
    </div>
    <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
        ...
        <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{ $season->id}}">
          <a wire:navigate.hover href="/products?selected_seasons[0]={{$season->id}}" class="">
            <img src="{{ url('storage', $season->image )}}" alt="{{ $season->name}}" class="object-cover w-full h-64 rounded-t-lg">
          </a>
...
<div class="bg-orange-200 py-20">
    <div class="max-w-xl mx-auto">
      <div class="text-center ">
        ...
        <p class="mb-12 text-base text-center text-gray-500">
            Category-wise food includes grains like rice and wheat, cereals such as oats and corn, pulses like lentils and beans, ensuring diverse nutritional options.
        </p>
      </div>
    </div>
    ...
    <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
      <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
        ...
        <a wire:navigate.hover class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="/products?selected_categories[0]={{$category->id}}" wire:key="{{$category->id}}">
...
<section class="py-14 font-poppins dark:bg-gray-800">
    <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
      <div class="max-w-xl mx-auto">
        <div class="text-center ">
          <div class="relative flex flex-col items-center">
            <h1 class="text-5xl font-bold dark:text-gray-200"> Customer <span class="text-blue-500"> Testimonials
              </span> </h1>
            <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
              <div class="flex-1 h-2 bg-blue-200">
              </div>
          ...
          <p class="mb-12 text-base text-center text-gray-500">
            Customer ratings reflect satisfaction, with stars or scores showcasing product quality, service, and overall experience on our platform.
          </p>
        </div>
      </div>
