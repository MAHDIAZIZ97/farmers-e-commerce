                   ...
                   @foreach($orders as $order)
                    ...
                    @php
                        ...
                        if($order->status =='shipped'){
                            $status = '<span class="bg-green-700 py-1 px-3 rounded text-white shadow">Shipped</span>';
                        }
                        ...
                        if($order->payment_status == 'paid'){
                            $payment_status = '<span class="bg-green-500 py-1 px-3 rounded text-white shadow">Pain</span>';
                        }
